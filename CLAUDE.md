...
**Current version: 2.0.0** (Phase 2 complete — MAJOR bump per the policy below, since the phase shipped new capabilities throughout) — see "Versioning" below. Keep this line current as `/bump-version` runs (that's the whole point of it).
