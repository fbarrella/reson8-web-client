...
**Current version: 3.0.0** (Phase 3 complete — MAJOR bump per the policy below, since the phase shipped new capabilities throughout) — see "Versioning" below. Keep this line current as `/bump-version` runs (that's the whole point of it).
